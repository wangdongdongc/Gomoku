 ...
 * 由两个半圆拼成的圆形按钮
 */
var TwoHalfButton = (function (_super) {
    __extends(TwoHalfButton, _super);
    function TwoHalfButton(centerX, centerY, radius, leftColor, rightColor) {
